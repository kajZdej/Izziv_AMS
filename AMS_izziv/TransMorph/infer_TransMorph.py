...
from data.datasets import NiiGzDataset  # Import the NiiGzDataset class
...
def main():
    ...
    test_set = NiiGzDataset(test_dir, transforms=test_composed)  # Updated to use NiiGzDataset
